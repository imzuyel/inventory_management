...
<section class="content">
    <ol class="breadcrumb breadcrumb-col-pink ">
        <li><a href="javascript:void(0);"><i class="material-icons">widgets</i>Employee</a></li>
        <li><a href="javascript:void(0);"><i class="material-icons">widgets</i>Manage Employee</a></li>
