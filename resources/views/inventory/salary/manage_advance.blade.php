...
@section('salary_manage_advance') active @endsection
@section('title') Manage advance salary @endsection
@section('content')
<section class="content">

    <div class="container-fluid">
        <ol class="breadcrumb breadcrumb-col-pink ">
            <li><a href="{{ route('salary.index_advance') }};"><i class="material-icons">attach_money</i>Advance salary</a></li>
            <li class="active"><i class="material-icons">add</i>Manage advance salary</li>
        </ol>
        <!-- Exportable Table -->
                ...
                <div class="card">
                    ...
                    <div class="body">
                        <div class="table-responsive text-center">
                            <table
                                class=" table-bordered table-striped table-hover @if(count($salaries)>0) dataTable js-exportable @endif">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                         ...
                                         <span class="label bg-green">   {{ $salary->salary - $salary->advance_salary}} due </span>
                                            @else
                                         <span class="label bg-red"> {{$salary->advance_salary - $salary->salary }} advance </span>
                                            @endif
